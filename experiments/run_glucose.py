...
# Delta U = U(A) - U(B)
#
# This runner reports paired bootstrap CIs only.
# P-values / Holm adjustment are handled separately.
# =============================================================
...
def _extract_evaluation_score(
    ...
    *candidate_keys,
    ...
    raise KeyError(
        "None of the expected prediction keys were found: "
        + ", ".join(
            repr(
                key
            )
...
def _check_default_cohort_counts(
    ...
    if mismatches:
        ...
        raise RuntimeError(
            "Glucose cohort does not match the configured "
...
def run_glucose(
    ...
    *,
    ...
    # =========================================================
    # 2. Fixed discovery / evaluation split
    #
    # IMPORTANT:
    # The final glucose notebook stratifies the outer split
    # by the binary outcome.
    #
    #     stratify = analysis_df[outcome_col]
    #
    # Representative:
    #     split seed = 70
    # =========================================================
    ...
    # ---------------------------------------------------------
    # Effect-modifier representation:
    # CF / BCF / DT / RF
    # ---------------------------------------------------------
    ...
    # =========================================================
    # 7. Matched causal-tree subgroup policy
    #
    # Maximum leaves matched to K-means K=4.
    # =========================================================
    ...
    # =========================================================
    # 8. Causal Forest teacher -> DT/RF students
    #
    # Glucose final settings:
    #     CF trees = 400
    #     DT depth = 4
    #     RF trees = 5
    # =========================================================
    ...
    cf = fit_cf_distillation(
        ...
        # For glucose, adjustment and effect modifiers
    ...
    # =========================================================
    # 10. Evaluation benefit-score vectors
    # =========================================================
    ...
    # =========================================================
    # 11. PRIMARY individualized policies
    #
    # Original exact-score representation.
    #
    # Threshold extension is NOT used here; it belongs only
    # to the separate sensitivity analysis.
    # =========================================================
    ...
    all_policies = {
        ...
        # s(X)=1 for all rows.
        # The selective-shift evaluator activates the
        # intervention only for factual T=1 observations.
        "Shift all eligible":
            np.ones(
                len(
                    evaluation_df
    ...
    # =========================================================
    # 15. Selective-shift DR evaluation + bootstrap CIs
    # =========================================================
    ...
    if run_inference:
        ...
        # -----------------------------------------------------
        # Paired utility differences + 95% CIs only.
        #
        # Sign-tail p-values + Holm are intentionally handled
        # outside this common inference module.
        # -----------------------------------------------------
    ...
    return {
        ...
        # Needed by outcome-nuisance sensitivity
        "learned_policies":
            learned_policies,
