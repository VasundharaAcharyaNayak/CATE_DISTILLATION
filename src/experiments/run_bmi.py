...
def _resolve_data_path(config):
    """
    Resolve the YAML data path relative to the repository root.
    """
...
def _check_default_cohort_counts(
    ...
    if mismatches:
        ...
        raise RuntimeError(
            "BMI cohort does not match the configured "
...
def run_bmi(
    ...
    *,
    ...
    cf = fit_cf_distillation(
        ...
        # In BMI, adjustment and effect-modifier sets coincide.
        W_discovery=None,
    ...
    #
    # IMPORTANT:
    # exact-score implementation from the primary notebook,
    # NOT threshold extension.
    # =========================================================
    ...
    all_policies = {
        ...
        # s(X)=1 for every X.
        # The selective-shift evaluator activates this only
        # for factual T=1.
        "Shift all eligible":
            np.ones(
                len(
    ...
    (
        ...
        # YAML specifies ±0.05.
        # fidelity.py uses total width 0.10.
        boundary_bandwidth=
            2.0
            * half_width,
    ...
    if run_inference:
        ...
        # -----------------------------------------------------
        # Paired utility differences + percentile 95% CIs only.
        #
        # No p-values / Holm adjustment are performed here.
        # -----------------------------------------------------
    ...
    # 17. Return objects
    #
    # This structure is intentionally useful for the later
    # sensitivity runners.
    # =========================================================
